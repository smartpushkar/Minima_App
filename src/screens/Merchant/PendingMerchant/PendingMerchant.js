...
import { Pending_Status } from "../../../config/AppConstants";
...
const PendingMerchant = () => {
    ...
    useEffect(() => {
        const getMerchantActiveList = async () => {
            try {
                const res = await actions.getMerchantListAction(Pending_Status)
    ...
    const handleViewMerchant = (merchantId) => {
        ...
        LocalStorageUtils.setItem('viewMerchantRedirecte', '/Merchant/Pending');
                    ...
                    <div className="container-fluid">
                        <div className="card bg-light-info shadow-none position-relative overflow-hidden">
                            <div className="card-body px-2 py-3">
                                <div className="row align-items-center">
                                    <div className="col-9">
                                        <h4 className="fw-semibold mb-8">Pending Merchant</h4>
                        ...
                        <div class="card w-100 position-relative overflow-hidden">
                            <div class="px-2 py-2 border-bottom">
                                <h5 class="card-title fw-semibold mb-0 lh-sm">Pending Merchant</h5>
                            </div>
                                                    ...
                                                    merchantList?.map(data => (
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                {/* <button type="button" class="btn mb-1 waves-effect waves-light btn-sm btn-danger mx-1">
